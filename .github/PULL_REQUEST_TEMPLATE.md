...
- [ ] Release changes that affect packaged artifacts prove the v14.6.0→v14.6.1 repository-patch round-trip plus declarative release-content/source-manifest equivalence.
