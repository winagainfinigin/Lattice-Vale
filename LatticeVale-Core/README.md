...
This directory contains the complete inspectable installer implementation. The recommended public entry point is the `../installer/install.ps1`, which verifies `SOURCE-SHA256SUMS.txt` and then invokes `Install-LatticeVale.ps1`.
