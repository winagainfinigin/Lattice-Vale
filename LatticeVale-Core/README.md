...
- Current v14.6.1 extends the deterministic release contract to 142 fixtures. The suite retains all v14.5.47 GPU recovery, v14.5.46 onboarding, v14.5.45 PowerShell, v14.5.44 DirectML preflight, v14.5.43 migration, and earlier preservation guarantees while adding adaptive architecture/release-policy gates.
