...
assert version in {'14.3.10','14.3.11','14.3.12','14.3.13','14.3.14','14.3.15','14.3.16','14.3.17','14.3.18','14.3.19','14.3.20','14.3.21','14.3.22','14.3.23','14.3.24','14.3.25','14.3.26','14.3.27','14.3.28','14.3.29','14.3.30','14.3.31','14.3.36','14.3.37','14.3.38','14.3.40','14.3.41','14.3.42','14.3.43','14.4.0','14.4.1','14.4.2'}, version
...
# The refresh interval is age-based rather than tied to how old the prior LatticeVale release is.
# A separate policy revision lets a future package-layer change force one immediate convergence
# refresh without making every ordinary installer patch implicitly update dependencies.
assert 'MANAGED_REPAIR_REFRESH_DAYS=30' in compat
assert 'MANAGED_REPAIR_REFRESH_REVISION=1' in compat
