...
assert ('MANAGED_REPAIR_REFRESH_REVISION=2' in compat) if version in {'14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82'} else ('MANAGED_REPAIR_REFRESH_REVISION=1' in compat)
...
if version in {'14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82'}:
    ...
    if version in {'14.4.6','14.4.7','14.4.8','14.4.81','14.4.82'}:
