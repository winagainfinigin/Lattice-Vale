...
assert version in {'14.5.45','14.5.46','14.5.47','14.6.0','14.6.1'}, version
...
assert ('return @($script:LatticeValeWindowsGpuInventoryCache)' in gpu and '$items.ToArray()' in gpu) if version in {'14.5.47','14.6.0','14.6.1'} else ('return $items.ToArray()' in gpu)
