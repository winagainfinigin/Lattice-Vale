...
assert version in {'14.4.3','14.4.4','14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82','14.4.83','14.4.84','14.4.85','14.5.0','14.5.1','14.5.2','14.5.3','14.5.4','14.5.42','14.5.43','14.5.44','14.5.45','14.5.46','14.5.47','14.6.0','14.6.1'}, version
...
def run_refresh(mode: str, seed_v2: bool = False) -> Path:
    ...
    assert (td / '.latticevale-resource-state').read_text(encoding='utf-8').startswith('POLICY_VERSION=13\n')
