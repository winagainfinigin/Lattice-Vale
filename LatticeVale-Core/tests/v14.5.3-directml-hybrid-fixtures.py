...
assert (ROOT/'VERSION.txt').read_text().strip() in {'14.5.3','14.5.4','14.5.42','14.5.43','14.5.44','14.5.45','14.5.46','14.5.47','14.6.0','14.6.1'}
...
assert '# LatticeVale v14.6.1' in (REPO/'README.md').read_text()
