...
assert ('if (Test-RelayTargetForServices $currentIp $services)' in relay) if (root/'VERSION.txt').read_text().strip() in {'14.3.30','14.3.31','14.3.36','14.3.37','14.3.38','14.3.40','14.3.41','14.3.42','14.3.43','14.4.0','14.4.1','14.4.2','14.4.3','14.4.4','14.4.5','14.4.6','14.4.7'} else ('if (Test-WslIpForServices $currentIp $services)' in relay)
