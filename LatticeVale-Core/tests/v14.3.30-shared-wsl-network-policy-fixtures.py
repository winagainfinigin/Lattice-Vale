...
assert version in {'14.3.30','14.3.31','14.3.36','14.3.37','14.3.38','14.3.40','14.3.41','14.3.42','14.3.43','14.4.0','14.4.1'}, version
...
assert ('shared native-Ollama/Tailscale networking policy must record a verified non-mirrored topology' in audit) if version in {'14.3.41','14.3.42','14.3.43','14.4.0','14.4.1'} else ('shared native-Ollama/Tailscale networking policy must record a verified NAT or mirrored topology' in audit)
