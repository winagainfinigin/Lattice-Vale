...
assert current_refresh_revision == 2
...
assert 'POLICY_VERSION=3' in cfg
assert PUBLIC_14_4_2_RESOURCE_POLICY < 3
...
# without a managed image/source refresh when its revision-2/policy-v3 state is current.
