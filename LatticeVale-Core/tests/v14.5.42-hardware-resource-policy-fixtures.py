...
# Canonical policy v13 is frozen once, then consumed by Compose/state/diagnostics.
for marker in (
    "Policy v13 canonicalization", "declare -A resource_policy=(", "[POLICY_VERSION]=13",
...
emit_start = cfg.index("rm -f compose.latticevale.yaml", cfg.index("Policy v13 canonicalization"))
