...
if (root/'VERSION.txt').read_text().strip() in {'14.3.30','14.3.31','14.3.36','14.3.37','14.3.38','14.3.40','14.3.41','14.3.42','14.3.43','14.4.0','14.4.1','14.4.2','14.4.3','14.4.4','14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82','14.4.83','14.4.84','14.4.85','14.5.0','14.5.1','14.5.2','14.5.3','14.5.4','14.5.42','14.5.43','14.5.44','14.5.45','14.5.46','14.5.47','14.6.0','14.6.1'}:
...
assert '$readyDeadline = [DateTime]::UtcNow.AddSeconds(120)' in ps
assert "Invoke-WslDirectCapture $Name $User 'curl'" in ps
assert 'seq 1 120' not in ps[ps.index('function Set-SynapsePublicBaseUrl'):ps.index('function Test-MatrixClientDiscovery')]
