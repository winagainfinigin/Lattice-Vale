...
assert 'resource_ram_context_recommendation() {' in cs and 'mem_mib <= 8192' in cs and 'printf 4096' in cs and 'printf 16384' in cs and 'printf 32768' in cs and 'printf 65536' in cs
...
assert "printf '0s'; else printf '30s'" in cs
