...
assert version in {'14.3.42','14.3.43','14.4.0','14.4.1','14.4.2','14.4.3','14.4.4','14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82','14.4.83'}
...
assert r'LatticeVale-Core\VERSION.txt' in reset and r"'installer\install.ps1'" in reset
