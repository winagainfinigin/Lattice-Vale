...
assert version in {'14.4.1','14.4.2','14.4.3','14.4.4','14.4.5','14.4.6','14.4.7','14.4.8','14.4.81','14.4.82','14.4.83'}, version
...
for name in ('install.ps1','uninstall.ps1','verify-release.ps1','SOURCE-SHA256SUMS.txt'):
...
install=(INSTALLER/'install.ps1').read_text(encoding='ascii')
uninstall=(INSTALLER/'uninstall.ps1').read_text(encoding='ascii')
...
assert "installer\\install.ps1" in reset

landing=(ROOT/'README.md').read_text(encoding='utf-8')
assert '.\\installer\\verify-release.ps1' in landing
assert '.\\installer\\install.ps1' in landing
assert '.\\installer\\uninstall.ps1' in landing
