...
r=subprocess.run([sys.executable,str(ROOT/'tests/v14.4.84-hotfix2-reconcile-startup-fixtures.py')],capture_output=True,text=True)
check(r.returncode==0, 'v14.4.84 Hotfix 2 reconcile startup-readiness audit failed: ' + (r.stdout+r.stderr).strip())
r=subprocess.run([sys.executable,str(ROOT/'tests/v14.4.84-hotfix2-post-gateway-readiness-fixtures.py')],capture_output=True,text=True)
check(r.returncode==0, 'v14.4.84 Hotfix 2 post-gateway readiness audit failed: ' + (r.stdout+r.stderr).strip())
