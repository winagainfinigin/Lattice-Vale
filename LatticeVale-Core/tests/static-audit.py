...
r=subprocess.run([sys.executable,str(ROOT/'tests/v14.4.85-reconcile-startup-fixtures.py')],capture_output=True,text=True)
check(r.returncode==0, 'v14.4.85 reconcile startup-readiness audit failed: ' + (r.stdout+r.stderr).strip())
r=subprocess.run([sys.executable,str(ROOT/'tests/v14.4.85-post-gateway-readiness-fixtures.py')],capture_output=True,text=True)
check(r.returncode==0, 'v14.4.85 post-gateway readiness audit failed: ' + (r.stdout+r.stderr).strip())
r=subprocess.run([sys.executable,str(ROOT/'tests/v14.4.85-update-backup-audit-fixtures.py')],capture_output=True,text=True)
check(r.returncode==0, 'v14.4.85 update-backup/read-only-audit audit failed: ' + (r.stdout+r.stderr).strip())
...
if version in {'14.4.7','14.4.8','14.4.81','14.4.82','14.4.83','14.4.84','14.4.85'}:
...
if version in {'14.4.82','14.4.83','14.4.84','14.4.85'}:
