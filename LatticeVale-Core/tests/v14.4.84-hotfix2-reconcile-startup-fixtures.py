...
assert version == '14.4.84', 'Hotfix 2 intentionally keeps public version 14.4.84'
...
assert "kanban_gateway) printf '4'" in checkpoint  # Hotfix 2 final candidate advances the final gateway lifecycle stage too.
...
assert r.returncode == 0, r.stderr
print('v14.4.84 HOTFIX 2 RECONCILE STARTUP FIXTURES: PASS')
