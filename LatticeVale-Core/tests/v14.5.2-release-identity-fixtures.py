...
root=(REPO/'README.md').read_text(encoding='utf-8'); assert '| **v14.5.2** | Release |' in root if version in {'14.5.3','14.5.4','14.5.42','14.5.43','14.5.44','14.5.45','14.5.46'} else '| **v14.5.2** | **Current install release** |' in root
