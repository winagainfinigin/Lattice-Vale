...
assert version in {"14.5.1","14.5.2","14.5.3","14.5.4","14.5.42","14.5.43","14.5.44",'14.5.45','14.5.46','14.5.47','14.6.0','14.6.1'}, version
...
for marker in (
    ...
    "Reconcile completed but the live Docker CPU/RAM ceilings still do not match policy v13",
):
...
assert "policy v13" in features.lower()
