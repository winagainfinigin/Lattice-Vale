NOTICE: reverted to v14.4.6 for now. v14.4.7 is bugged. If you installed the 14.4.7 version as a repair install, LatticeVale will fail from then on, but your completed install will still function. If you haven't gotten too far with new user data with a completed install after patching to v14.4.7, I recommend starting over with a clean install. v14.4.8x will be out soon and will hopefully fix everything regardless.
